...
деплой бэка на гличе (особенность глича - сервер засыпает, если не делать на него запросы, если делать - просыпается, поэтому ПЕРВЫЙ запрос загружается 14 секунд, надо подождать:) :
